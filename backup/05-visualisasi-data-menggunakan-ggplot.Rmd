...
Pada contoh berikut disajikan sebagian contoh penerapan tema pada plot. Contoh Output disajikan pada Gambar \@ref(fig:ggtema).

```{r ggtema, fig.cap='Scatterplot (theme_bw)', tidy=FALSE, fig.align='center', out.width='70%', message=FALSE}
ggplot(gapminder, aes(gdpPercap, lifeExp))+
  geom_point()+
  theme_bw()
```
...
Pada contoh berikut disajikan sebagian contoh penerapan tema pada plot. Contoh Output disajikan pada Gambar \@ref(fig:ggtema2).

```{r ggtema2, fig.cap='Scatterplot dengan (theme_wsj)', tidy=FALSE, fig.align='center', out.width='70%', message=FALSE}
ggplot(gapminder, aes(gdpPercap, lifeExp, 
                      color=continent))+
  geom_point()+
  theme_wsj()
